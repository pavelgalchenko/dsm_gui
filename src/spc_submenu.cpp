...
void SPC_submenu::set_validators() {
   ...
   ui->spc_cur_body_poi_x->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_poi_y->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_poi_z->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_body_com_x->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_com_y->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_com_z->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_body_cem_x->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_cem_y->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_cem_z->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_body_cemd_x->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_cemd_y->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_body_cemd_z->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_joint_ang0_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_ang0_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_ang0_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_angrate0_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_angrate0_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_angrate0_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_disp0_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_disp0_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_disp0_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_dispr0_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_dispr0_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_dispr0_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_bigi_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_bigi_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_bigi_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_bogo_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_bogo_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_bogo_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_poswrt_in_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_poswrt_in_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_poswrt_in_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_joint_poswrt_out_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_poswrt_out_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_joint_poswrt_out_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   // Wheels
   ui->spc_cur_wheel_name->setValidator(noQuotes);

   ui->spc_cur_wheel_initmom->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_wheel_maxtrq->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_wheel_maxmom->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_wheel_inertia->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_thruster_force->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_gyro_samptime->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_gyro_scaleferror->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_gyro_quant->setValidator(new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_gyro_angrwalk->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ui->spc_cur_gyro_angnoise->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_gyro_bias_stab->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ui->spc_cur_gyro_bias_tspan->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_gyro_initbias->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_mag_scaleferror->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_fss_mount_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_fss_mount_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_fss_mount_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_strack_samptime->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_strack_mount_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_strack_mount_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_strack_mount_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_strack_noiseang_1->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ui->spc_cur_strack_noiseang_2->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ui->spc_cur_strack_noiseang_3->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_gps_timenoise->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ...
   ui->spc_cur_acc_scaleerror->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_acc_quant->setValidator(new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_acc_dvrandwalk->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_acc_bias_stab->setValidator(
       new QDoubleValidator(0, INFINITY, 5));
   ui->spc_cur_acc_bias_tspan->setValidator(
       new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_acc_dvnoise->setValidator(new QDoubleValidator(0, INFINITY, 5));

   ui->spc_cur_acc_initbias->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
}
   ...
   if (thrusters > 0) {
      for (int line_num = reset_ind_thr + thr_headers;
         ...
         if (cur_entry == thr_entries - 1) {
            ...
            ui->spc_cur_thruster_list->currentItem()->setData(256,
                                                              cur_item_name);
...
void SPC_submenu::on_sections_tabBarClicked(int index) {
   ...
   } else if (index == 2 && ui->spc_cur_joint_list->count() > 0) {
...
void SPC_submenu::proc_duplicates(QListWidget *cur_list) {
   ...
   for (int i = 0; i <= 30; i++) {
      ...
      if (i > 0)
         newItemTest += "_" + QString::number(i);
