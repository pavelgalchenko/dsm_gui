...
void SPC_Menu::set_validators() {
   ...
   ui->spc_cur_xpos_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_ypos_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_zpos_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_xvel_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_yvel_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_zvel_form->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));

   ui->spc_cur_angvel_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_angvel_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_angvel_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ...
   ui->spc_cur_initeul_1->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_initeul_2->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
   ui->spc_cur_initeul_3->setValidator(
       new QDoubleValidator(-INFINITY, INFINITY, 5));
