...
ERROR_MSG = 'ERROR' # Global Constant
...
from functools import partial # for controller o connect signals with methods that need to take extra arguments

__version__ = '0.1'
__author__ = 'Leodanis Pozo Ramos'

# Create a subclass of QMainWindow to setup the calculator's GUI
class PyCalcUi(QMainWindow): # creates the GUI with the class PyCalcUi
    """PyCalc's View (GUI)."""
    def __init__(self):
        """View initializer."""
        super().__init__()
        ...
        self.setFixedSize(235, 235) # uses .setFixedSize() to give the window a fixed size
